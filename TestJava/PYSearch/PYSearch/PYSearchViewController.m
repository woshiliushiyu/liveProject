...
- (void)viewDidLayoutSubviews
{
    ...
    _searchBar.layer.cornerRadius = self.view.py_width > self.view.py_height ? 12 : 15;
...
#pragma clang diagnostic pop
        ...
        searchSuggestionVC.view.frame = CGRectMake(0, CGRectGetMaxY(self.navigationController.navigationBar.frame)+15, PYScreenW, PYScreenH);
